...
#        print(f"Error en la activación: {e}")       
        user = None
...
def forgotPassword(request):
    if request.method == 'POST':
        ...
        if Account.objects.filter(email=email).exists():
            ...
            messages.success(request, 'Un email fue enviado a tu bandeja de emtrada para resetear tu password')
            return redirect('login')
        else:
    ...
    if request.method == 'POST':
        ...
        if new_password == confirm_password:
            ...
            if success:
                ...
                messages.success(request, 'El Password se actualizó exitosamente')
            ...
            messages.error(request, 'El password no coincide con la confirmación de password')
            return redirect('change_password')
